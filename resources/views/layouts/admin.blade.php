...
<body class="h-full bg-slate-100 flex overflow-hidden">
    ...
    <!-- Desktop Sidebar (Exact TecnoStore Dark Navy Style: #0a1931) -->
    ...
    <!-- Mobile Drawer JavaScript Engine -->
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (bottomMenuBtn) bottomMenuBtn.addEventListener('click', openSidebar);
